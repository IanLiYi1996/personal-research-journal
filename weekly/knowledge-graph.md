...
| # | 规模 | 内聚度 | 构成 | 核心笔记（按连接数） |
|---|---|---|---|---|
| 6 | 20 | 0.232 | research-notes×16, weekly×3, tech-blogs×1 | `2026-07-20-long-horizon-agents.md`<br>`2026-07-20-blog-reasoning-effort.md`<br>`2026-07-20-llm-long-context.md` |
| 7 | 20 | 0.2 | research-notes×10, reddit-digests×5, tech-blogs×5 | `2026-07-21-raschka-llm-architecture-comparison.md`<br>`2026-W31-reddit-hot.md`<br>`2026-07-17-agentic-rl-credit-and-unified-multimodal.md` |
| 14 | 15 | 0.448 | research-notes×8, topics×6, reddit-digests×1 | `2026-06-12-agent-evolution.md`<br>`2026-06-12-ai-frontier-comprehensive.md`<br>`2026-06-12-trends.md` |
| 15 | 11 | 0.218 | research-notes×6, tech-blogs×2, reddit-digests×2, weekly×1 | `2026-W26.md`<br>`2026-06-26-hf-daily-papers-jun17-25.md`<br>`2026-W26-reddit-hot.md` |
| 11 | 9 | 0.472 | topics×9 | `2026-02-09-llm-intro-comprehensive.md`<br>`2026-02-09-llm-intro-architecture.md`<br>`2026-02-09-llm-intro-post-training.md` |
| 13 | 9 | 0.5 | topics×9 | `2026-04-15-quantum-computing-comprehensive.md`<br>`2026-04-15-quantum-intro-for-everyone.md`<br>`2026-04-15-quantum-frontiers.md` |
| 2 | 8 | 0.429 | papers×5, research-notes×2, topics×1 | `2026-05-08-cot-mechanism-mini-survey.md`<br>`2025-agentic-rl-survey.md`<br>`2026-05-08-graph-structures-meet-llms.md` |
| 4 | 4 | 0.833 | research-notes×4 | `2026-05-26-two-harness-surveys-comparison.md`<br>`2026-05-25-agent-harness-engineering-survey.md`<br>`2026-05-07-aidlc-deep-dive.md` |
| 9 | 2 | 1.0 | papers×1, research-notes×1 | `2026-openclaw-rl.md`<br>`2026-04-13-agentic-rl-infrastructure-comparison.md` |
...
| 10 | 1 | 0.0 | papers×1 | `2026-cafm-constraint-aware-flow-matching.md` |
| 12 | 1 | 0.0 | topics×1 | `2026-02-09-3d-generation-survey.md` |
| 16 | 1 | 0.0 | reddit-digests×1 | `2026-W25-reddit-hot.md` |

## 2. 桥节点（连接 ≥3 个社区的枢纽笔记）

| 笔记 | 跨社区数 | 连接数 | 标题 |
|---|---|---|---|
| `research-notes/2026-07-20-long-horizon-agents.md` | 4 | 14 | 深度整理：Long-Horizon Agents（长程智能体）研究路径全景 |
| `topics/ai-frontier-2026h1/2026-06-12-agent-evolution.md` | 4 | 12 | Agent 体系演化谱系 · 2026 上半年 |
| `research-notes/2026-07-08-blog-harness-engineering.md` | 3 | 6 | Blog Deep Dive: Harness Engineering for Self |
| `research-notes/2026-07-08-blog-global-workspace.md` | 3 | 3 | Blog Deep Dive: A Global Workspace in Langua |
| `research-notes/2026-07-20-blog-reasoning-effort.md` | 3 | 11 | 综述：LLM 推理努力度控制（Controlling Reasoning Effort  |
...
| 3.46 | `2026-07-20-long-horizon-agents.md` | `2025-agentic-rl-survey.md` | 4.61 | 2 | 跨社区+跨类型 |
| 3.42 | `2026-05-26-two-harness-surveys-comparison.md` | `2026-06-12-agent-evolution.md` | 4.2 | 1 | 跨社区+跨类型 |
| 3.42 | `2026-05-26-two-harness-surveys-comparison.md` | `2026-06-12-ai-frontier-comprehensive.md` | 4.18 | 1 | 跨社区+跨类型 |
| 3.41 | `2026-05-26-two-harness-surveys-comparison.md` | `2026-06-12-trends.md` | 4.15 | 1 | 跨社区+跨类型 |
...
| 3.3 | `2026-07-20-blog-reasoning-effort.md` | `2025-agentic-rl-survey.md` | 2.95 | 1 | 跨社区+跨类型 |
| 3.26 | `2026-07-21-raschka-llm-architecture-comparison.md` | `2026-W26-reddit-hot.md` | 2.63 | 1 | 跨社区+跨类型 |
| 3.24 | `2026-07-20-long-horizon-agents.md` | `2026-06-12-agent-evolution.md` | 2.38 | 1 | 跨社区+跨类型 |
| 3.24 | `2026-07-20-long-horizon-agents.md` | `2026-05-08-graph-structures-meet-llms.md` | 2.38 | 1 | 跨社区+跨类型 |
| 3.21 | `2025-agentic-rl-survey.md` | `2026-06-12-agent-evolution.md` | 2.12 | 1 | 跨社区+跨类型 |
| 3.15 | `2026-04-03-huggingface-daily-papers-digest.md` | `2026-06-12-auto-research.md` | 1.55 | 1 | 跨社区+跨类型 |

## 4. 知识缺口

### 4.1 孤立笔记（连接数 ≤1，共 21 篇）
...
- `tech-blogs/2026-W31f.md`（degree=1）— 技术博客周报 · 2026-W31f(07/23–07/30 夜间补抓)
