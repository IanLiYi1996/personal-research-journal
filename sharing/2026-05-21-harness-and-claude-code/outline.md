...
- **听众**：硕士师弟师妹 ~20 人
- **时长**：75 分钟核心 + Q&A
- **deck**：[`slides.html`](./slides.html) · **38 页**
...
| 00:02 - 00:03 | 3 | 📒 **Glossary · 13 个核心术语**（拍照） | 1′ |
| 00:03 - 00:06 | 4 | **Hook · 3 道自查（举手互动）** | 3′ |
| 00:06 - 00:10 | 5 | What is Harness（定义 + 类比 + Humans steer） | 4′ |
| 00:10 - 00:13 | 6 | Why Prompts Fail · 3 大病根 | 3′ |
| 00:13 - 00:15 | 7 | Harness 5 层架构（扫一眼） | 2′ |
| 00:15 - 00:16 | 8 | 6 大设计模式（地图，不展开） | 1′ |
| 00:16 - 00:19 | 9 | 🎓 学术背书 · binding-constraint thesis · 3 个硬数据 | 3′ |
| 00:19 - 00:21 | 10 | 🎓 ETCLOVG 七层分类 · 170+ 项目映射 | 2′ |
| 00:21 - 00:23 | 11 | 3 层成熟度（**举手互动**） | 2′ |
| 00:23 - 00:27 | 12 | 3 组 prompt 模板（拍照） | 4′ |
| 00:27 - 00:30 | 13 | AI Pipeline 6 阶段总览 | 3′ |
| 00:30 - 00:33 | 14 | 真实加速比（含周-月级修正） | 3′ |
| 00:33 - 00:39 | 15-20 | 6 阶段详情（每页 ~1′） | 6′ |
| 00:39 - 00:41 | 21 | Artifact Registry = Bus | 2′ |
| 00:41 - 00:44 | 22 | 🔑 实验流程对比图 | 3′ |
| 00:44 - 00:47 | 23 | 🔑 5 个科学性属性（**反向自查**） | 3′ |
| 00:47 - 00:49 | 24 | spec.yaml 范例（拍照） | 2′ |
| 00:49 - 00:50 | 25 | Demo intro | 1′ |
| 00:50 - 01:00 | 26-27 | **Demo 幕一**：读论文 + 拆解 | 10′ |
| 01:00 - 01:10 | 28-29 | **Demo 幕二**：写笔记 + 拆解 | 10′ |
| 01:10 - 01:14 | 30 | ☕ 中场 4′ + 互动 | 4′ |
| 01:14 - 01:25 | 31-32 | **Demo 幕三**：跑实验 + 拆解 | 11′ |
| 01:25 - 01:29 | 33 | 回到 6 阶段 · 最小动作清单 | 4′ |
| 01:29 - 01:31 | 34-35 | 4 件套 + CLAUDE.md 范例 | 2′ |
| 01:31 - 01:33 | 36 | 5 个 Takeaway | 2′ |
| 01:33 → | 37-38 | Q&A + 参考资料 | Q&A |

总核心 ~75′（如气氛紧凑可压到 70′），Q&A 至少留 10′。

## 关键节奏点

1. **Slide 3 Glossary**：⚠️ <strong>不要展开讲</strong>——30 秒让大家拍照即可。问一句"这 13 个里你之前听过几个" 举手互动。
2. **Slide 4 Hook**：每念一个问题问"中招的举手"——气氛立刻活起来
3. **Slide 5 定义页**："Humans steer. Agents execute." 这句话**写在白板上**，全场最重要的一句
4. **Slide 8 6 模式**：地图，**不要逐个讲**，只点①②⑤
5. **Slide 11 成熟度**：**用举手互动**问"在 L1 / L2 / L3 各几个人"
6. **Slide 12 prompt 模板**：明确说"会发原文给你们"
7. **Slide 15-20 6 阶段详情**：每页 ~1 分钟，不要超时；deck 设计成可会后回看
8. **Slide 22 流程对比图（🔑 全场最重要）**：左右并排讲，先念左边"散点式"5 步让师弟师妹听出"这就是我"，再讲右边 DDD/SDD/TDD 流程。**举手互动**：左边 5 步中招几个？
9. **Slide 23 5 个科学性属性**：底下"反向自查 5 问"让师弟师妹现场打分
10. **Slide 30 中场**：看气氛，气氛紧凑则 4′ 即可
11. **每幕 demo 控制 10-11 分钟**，不要为了"完整跑通"超时
